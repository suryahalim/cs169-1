...
class RestaurantIntegrationTest < ActionDispatch::IntegrationTest
  test "create and login" do
    https!
    get "/login"
    assert_response :success

    #create user test
    post_via_redirect create_user_path, 'user[name]' => 'FendyOnel', 'user[email]' => 'FendyOnel@gmail.com', 'user[password]' => '123123123', 'user[password_confirmation]' => '123123123'
    assert_equal '/profile', path

    #sign in test
    post_via_redirect user_session_path, 'user[email]' => 'FendyOnel@gmail.com', 'user[password]' => '123123123'
    assert_equal '/profile', path
  ...
  test "login waitlist restaurant already sign up" do
    ...
    get new_user_session_path, 'user[email]' => 'FendyOnel@gmail.com', 'user[password]' => '123123123'
